      ...
      <section className="relative">
        <div className="relative z-10">
          <div className="mx-auto max-w-7xl px-6 md:px-12">
            <div className="text-left sm:text-center sm:mx-auto sm:w-10/12 lg:mr-auto lg:mt-0 lg:w-4/5">
              {/* Annonce Badge */}
              <a
                href="/"
                className="annonce variant-outlined sz-sm group w-fit gap-2 border-white/20 bg-white/10 backdrop-blur-3xl dark:bg-white/5 mx-auto sm:mx-auto"
              >
              ...
              {/* Hero Title */}
              <h1 className="text-title mt-8 text-wrap text-5xl font-semibold uppercase sm:text-5xl xl:text-5xl xl:[line-height:1.125]">
                Upload, Simpan, dan Bagikan Gambar dengan Mudah
              </h1>

              {/* Hero Description */}
              <p className="text-body mt-8 max-w-2xl text-justify text-lg sm:mx-auto sm:text-center">
                HostImgAja memudahkan kamu mengunggah, menyimpan, dan membagikan
                gambar secara cepat. Cukup upload gambarmu, dan langsung
                dapatkan link yang bisa dibagikan ke mana saja.
              </p>
